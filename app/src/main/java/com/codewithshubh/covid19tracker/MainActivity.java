    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                //Toast.makeText(MainActivity.this, "Data kembali disegarkan", Toast.LENGTH_SHORT).show();
            }
        });
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            str_confirmed_new = data_india.getString("deltaconfirmed");   //baru tekorfirmasi

                            str_active = data_india.getString("active");    //kasus aktiv negara

                            str_recovered = data_india.getString("recovered");  //total kesembuhan
                            str_recovered_new = data_india.getString("deltarecovered"); //kesembuhan baru

                            str_death = data_india.getString("deaths");     //Total kematian di india
                            ...
                            str_tests = test_data_india.getString("totalsamplestested"); //Total samples di india
                            str_tests_new = test_data_india.getString("samplereportedtoday");   //samples baru  untuk hari ini
